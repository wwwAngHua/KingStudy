    ...
    function Snowfall(newOptions) {
        ...
        function Snowflake() {
            ...
            if (options.type != 'solid') {
                _$snowflake[isImage ? 'src' : 'innerHTML'] =
                    typeof options.content == 'string'
                        ? options.content
                        : options.content[
                              cntLength == 0
                                  ? 0
                                  : Math.floor(Math.random() * cntLength)
                          ]
            }
        ...
        function snowAnimate() {
            ...
            if (queue.length) {
                ...
                if (_$snowflake.dataset.type != options.type)
